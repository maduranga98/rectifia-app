...
const PATHS = {
  ...
  globe:
    'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0-20c2.5 2.7 4 6.3 4 10s-1.5 7.3-4 10c-2.5-2.7-4-6.3-4-10s1.5-7.3 4-10ZM2.5 9h19M2.5 15h19',
  help: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3v.5 M12 17h.01',
  lock: 'M5 11h14v10H5V11Zm2 0V7a5 5 0 0 1 10 0v4M12 15v3',
}
