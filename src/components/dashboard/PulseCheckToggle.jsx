...
// number - and it's the same number the real Stripe Pulse Check item this
// toggle creates/updates/removes (via upgradeSubscription.js) is priced
// from.
//
// Requires a Core subscription to already exist (upgradeSubscription.js
// throws otherwise, surfaced here as a plain error message) - there is no
// Stripe subscription to attach a Pulse Check item to before Core's first
// Checkout has run. Proration on/off or moving bands uses Stripe's default
// (create_prorations), same as PackageSelector.
